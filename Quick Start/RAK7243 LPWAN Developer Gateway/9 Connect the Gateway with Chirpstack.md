...
- However if it is not the first time and you want to use the built-in ChirpStack as the LoRa® Server, follow the steps discussed in [Configuring the Gateway](https://doc.rakwireless.com/rak7243--lorawan----developer-gateway/configuring-the-gateway) section.
...
$plugin[{
    ...
    "data": {
        ...
        "width": 925,
        "height": 610,
        "caption": "**Figure 1**: IP address of your RAK7243 using IP Scanner"
    }
}]$
...
$plugin[{
    "type": "image",
    "data": {
        "url": "https:\/\/res.cloudinary.com\/developerhub\/image\/upload\/v1591358616\/23408\/xbevrkypreag5xqufdpi.png",
        "mode": "responsive",
        "width": 1934,
        "height": 1048,
...
$plugin[{
    "type": "image",
    "data": {
        "url": "https:\/\/res.cloudinary.com\/developerhub\/image\/upload\/v1591358638\/23408\/wrowvw7zxjsxttzcqfsh.jpg",
        "mode": "responsive",
        "width": 1920,
        "height": 929,
...
$plugin[{
    "type": "image",
    "data": {
        "url": "https:\/\/res.cloudinary.com\/developerhub\/image\/upload\/v1591358655\/23408\/hd8o28osfeuwvj4fr4dt.jpg",
        "mode": "responsive",
        "width": 1896,
        "height": 930,
...
$plugin[{
    "type": "image",
    "data": {
        "url": "https:\/\/res.cloudinary.com\/developerhub\/image\/upload\/v1591599433\/23408\/bjdbsy9lptyjhaszuotg.png",
        "mode": "responsive",
        "width": 1910,
        "height": 942,
...
- Fill in the Gateway ID that we got from the last section ([Configuring the Gateway](https://doc.rakwireless.com/rak7243--lorawan----developer-gateway/configuring-the-gateway)), also called Geteway EUI.
...
$plugin[{
    "type": "image",
    "data": {
        "url": "https:\/\/res.cloudinary.com\/developerhub\/image\/upload\/v1591599448\/23408\/ekge11dlselgqvgtdu6h.png",
        "mode": "responsive",
        "width": 1910,
        "height": 942,
